...
global food_place, snake_places, field, last_direction
empty = '.'
snake = 'o'
food = '*'
score = 0
...
def main(stdscr):
    def game_over():
        ...
        stdscr.addstr("Your score: " + str(score) + '\n')
        stdscr.refresh()
        stdscr.getch()
        exit()
    ...
    def move_snake(snake_place, snake_direction):
        nonlocal food_place, snake_places, field
        global score
        new_head = []
    ...
    def snake_move_itself():
        nonlocal field, snake_places, food_place, last_direction
